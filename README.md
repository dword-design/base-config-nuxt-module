<!-- TITLE/ -->
# @dword-design/base-config-nuxt-module
<!-- /TITLE -->
...
```bash
# npm
$ npm install @dword-design/base-config-nuxt-module

# Yarn
$ yarn add @dword-design/base-config-nuxt-module
```
<!-- /INSTALL -->
...
Are you missing something or want to contribute? Feel free to file an [issue](https://github.com/dword-design/base-config-nuxt-module/issues) or a [pull request](https://github.com/dword-design/base-config-nuxt-module/pulls)! ⚙️
